...
class DatabaseConnection(object):
    ...
    def insert_doc(self, doc_id, path, content, original, timestamp):
        '''
        ...
        '''
        insert_doc = ("INSERT INTO document (id, path, content, original, timestamp) VALUES (%s, %s, %s, %s, %s)")
        data_doc = (doc_id, path, content, original, timestamp)
        try:
    ...
    def insert_data(self, data):
        ...
        '''
        for doc in data:
            self.insert_doc(doc['id'], doc['path'], doc['content'], doc['original'], doc['timestamp'])
